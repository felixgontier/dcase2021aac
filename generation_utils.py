...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        model_kwargs["encoder_outputs"]: ModelOutput = encoder(input_ids=input_ids if model_kwargs['inputs_embeds'] is None else None, return_dict=True, **encoder_kwargs)
        return model_kwargs
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if self.config.is_encoder_decoder:
            ...
            if model_kwargs["encoder_outputs"] is None: # ADDED FG - 18/08/21 - Bypass encoding if outputs are already provided
